...
export const loginWithGoogle = (tokenId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      "https://diary-liv9.onrender.com/auth/google",
      { tokenId },
      config
    )
...
export const registerUser = (user) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      "https://diary-liv9.onrender.com/api/users",
      user,
      config
    )
...
export const loginUser = (email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      "https://diary-liv9.onrender.com/api/users/login",
      { email, password },
      config
    )
...
export const createBookmark = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(
      `https://diary-liv9.onrender.com/api/users/${userId}/bookmarks`,
      { id },
      config
    )
...
export const getUserDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `https://diary-liv9.onrender.com/api/users/${id}`,
      config
    )
